...
public class ProductConfig {
    ...
    public static LinkedList<Product> productsWithIngredients(
        ...
        Long[][] list = {
                { 1l, 3l, 5l, 9l, 11l, 15l, 16l, 17l, 18l }, // ! Burgir
                { 1l, 3l, 8l, 9l, 10l, 11l, 12l, 19l }, // ! Cheeser
                { 1l, 3l, 11l, 12l, 16l, 20l }, // ! Hottuwa
                { 1l, 2l, 5l, 12l, 21l }, // ! Kurczaker
                { 1l, 4l, 11l, 12l, 18l, 22l, 23l }, // ! Veggie
        };

        for (int i = 0; i < list.length; i++) {
            Product product = productRepository.findById(i + 5l).get();

            for (int j = 0; j < list[i].length; j++) {
                Ingredient ingredient = ingredientRepository.findById(j + 1l).get();
